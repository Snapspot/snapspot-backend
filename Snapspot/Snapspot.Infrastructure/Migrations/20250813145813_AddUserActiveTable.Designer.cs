...
namespace Snapspot.Infrastructure.Migrations
{
    ...
    [Migration("20250813145813_AddUserActiveTable")]
    partial class AddUserActiveTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.CompanySellerPackage", b =>
                {
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.LikeComment", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.LikePost", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.SavePost", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SavePost", (string)null);
                });
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Style", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.StyleSpot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StyleSpot", (string)null);
                });
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.UserActive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserActive", (string)null);
                });
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Comment", b =>
                {
                    b.HasOne("Snapspot.Domain.Entities.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.CompanySellerPackage", b =>
                {
                    b.HasOne("Snapspot.Domain.Entities.Company", "Company")
                        .WithMany("CompanySellerPackages")
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.LikeComment", b =>
                {
                    b.HasOne("Snapspot.Domain.Entities.Comment", "Comment")
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.StyleSpot", b =>
                {
                    ...
                    b.HasOne("Snapspot.Domain.Entities.Style", "Style")
                        .WithMany("StyleSpots")
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Company", b =>
                {
                    ...
                    b.Navigation("CompanySellerPackages");
