...
namespace Snapspot.Infrastructure.Migrations
{
    ...
    [Migration("20250617053524_UpdateLatitudeLongitudeToNullable")]
    partial class UpdateLatitudeLongitudeToNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snapspot.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("Snapspot.Domain.Entities.User", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Snapspot.Domain.Entities.AgencyService", "Service")
                        .WithMany()
